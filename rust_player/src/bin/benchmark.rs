...
fn main() {
    ...
    println!("\n=================================================================");
    println!("  GAIM240 PERFORMANCE BENCHMARK SUITE (Rust YUV420P Optimized)");
    println!("=================================================================");
    ...
    for (idx, trial) in active_trials.iter().enumerate() {
        ...
        unsafe {
            let textures = [tex_a.y, tex_a.u, tex_a.v, tex_ref.y, tex_ref.u, tex_ref.v, tex_c.y, tex_c.u, tex_c.v];
