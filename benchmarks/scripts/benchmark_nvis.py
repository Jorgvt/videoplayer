...
NVIS_BIN = (ROOT_DIR.parent / "userstudy_v0.2_linux" / "userstudy_v0.2" / "userstudy_patched").resolve()
BANK_PATH = (ROOT_DIR / "all_trials_bank.csv").resolve()
DATASET_DIR = get_dataset_dir()
RUST_LIB_DIR = (ROOT_DIR / "rust_player" / "lib").resolve()
